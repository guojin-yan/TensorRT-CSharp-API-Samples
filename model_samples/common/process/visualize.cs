...
namespace TrtCommon
{
    ...
    {
        public static List<string> lables = new List<string>{ "plane","ship", "storage tank", "baseball diamond", "tennis court",
    ...
    public static class Visualize
    {
        ...
        /// <returns></returns>
        public static Mat DrawDetResult(DetResult result, Mat image)
        {
        ...
        public static Mat DrawObbResult(ObbResult result, Mat image)
        {
            // Draw recognition results on the image
            for (int i = 0; i < result.count; i++)
            {
        ...
        public static Mat DrawSegResult(SegResult result, Mat image)
        {
        ...
        /// <param name="image">image</param>
        public static Mat DrawPosesResult(PoseResult pose, Mat img, float visual_thresh = 0.2f, bool with_box = true)
        {
            Mat image = img.Clone();
